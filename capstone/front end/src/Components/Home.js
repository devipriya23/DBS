            ...
            if(sample[i].stats==="open"){
                if(sample[i].instrumentid===instrumentid){
                    if(sample[i].price===price){
                        ...
                        console.log("price is diff")
                    }
                }
                else{
                    console.log(" instrument id is diff")
                }
            }
            else{
                ...
                if(array[i].instrumentid===instrumentid){
                    if(array[i].price===price){
                        if(array[i].quantity===quantity)
                        {
                            ...
                            const pushdata={transactiontype,clientid,instrumentid,price,quantity}
                        ...
                        if(Number(quantity)<=Number(array[i].quantity)){
                            ...
                            e.preventDefault()
                            const transactiontype="buy"
                            const update={transactiontype,clientid, instrumentid ,price,quantity,stats}
